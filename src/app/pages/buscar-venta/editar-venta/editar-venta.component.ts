...
export class EditarVentaComponent implements OnInit {
  ...
  color = 'primary';
    ...
    iniciarCliente() {
        ...
        this.cliente.direccion.calle = this.firstFormGroup.controls['calleCtrl'].value;
        this.cliente.direccion.ciudad = this.firstFormGroup.controls['ciudadCtrl'].value;
        this.cliente.direccion.cod_postal = this.firstFormGroup.controls['cpCtrl'].value;
        this.cliente.direccion.colonia = this.firstFormGroup.controls['coloniaCtrl'].value;
        this.cliente.direccion.numero = this.firstFormGroup.controls['numeroCtrl'].value;
    }
    ...
    editarCotizacion() {
        ...
        if(this.cotizacion.estado == 'Completada') {
            this.cotizacionService.editarCotizacionPut(this.cotizacion).subscribe(res => {
                ...
                this.ventaService.editarVentaPut(this.ventas).subscribe(res => {
                    console.log('Venta guardada con exito')
                });
            });
